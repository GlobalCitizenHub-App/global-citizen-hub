...
function resolveBestMatch(input) {
    ...
    return { key: cleanInput, data: { zone: "continental", hemi: "north", type: "unknown" } };
}
...
document.getElementById('calculateBtn').addEventListener('click', function() {
    ...
    let match = resolveBestMatch(rawInput);
    if (match.data.type === "unknown") {
        alert('Please enter a recognized city or country and click "Confirm" before generating.');
        return;
    }
